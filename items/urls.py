...
urlpatterns = [
    ...
    path('add_to_wishlist/<slug:product_slug>/<str:flag>',views.add_remove_wishlist ,name='add_remove_wishlist'),
    path('cart_order/',views.cart_order,name='cart_order'),
    path('display_orders/<str:user_username>/',views.see_order,name='display_orders'),
    path('display_wishlist/<str:user_username>/',views.display_wishlist,name='display_wishlist'),
    path('product_order/<slug:product_slug>/', views.order, name='product_order'),
    path('show-cart/',views.show_cart,name='show_cart'),

    path('change_value/product-details/<slug:product_slug>/<str:flag>', views.change_value, name='change_value'),
    path('change_value/cart/<slug:product_slug>/<str:flag>', views.change_value_cart, name='change_value_cart'),
